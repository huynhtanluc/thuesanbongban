...
<body class="bg-login">
    <div class="wrapper">
        <div class="d-flex align-items-center justify-content-center my-5 my-lg-0">
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-2 mt-5">
                                        ...
                                        <form class="row g-3" action="/register" method="post">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="input-group" id="show_hide_repassword">
                                                    <input type="password" class="form-control border-end-0" name="re_password" required>
                                                    <a href="javascript:;" class="input-group-text bg-transparent">
                                                        <i class='bx bx-hide'></i>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" class="form-control" name="chung_minh_thu" required>
                                            </div>
                                            <div class="col-sm-6">
